...
import (
	...
	"log"
	"strsvc/internal/attribute/internal/db/mongo"
	"strsvc/internal/attribute/internal/evq"
	"sync"
	"time"
)
...
func NewMongoDbConfig(addr, dbName, user, password string) *MongoConfig {
	return &MongoConfig{
		Addr:     addr,
		DBName:   dbName,
		User:     user,
...
func (mc *MongoConfig) GetType() string     { return "mongodb" }
func (mc *MongoConfig) GetAddr() string     { return mc.Addr }
func (mc *MongoConfig) GetDB() string       { return mc.DBName }
func (mc *MongoConfig) GetUser() string     { return mc.User }
func (mc *MongoConfig) GetPassword() string { return mc.Password }
